    ...
    Private Sub Check_CHINOOK_TerminalRun(ByVal IterNum As Integer, ByVal BackFRAMIteration As Integer)
        ...
        For TRun = 1 To NumStk + NumChinTermRuns
            ...
            If BackwardsFlag(TRun) = 2 Then 'combined marked and unmarked; split starting cohort according to mark rates in current model run
                ...
                Stk = TermStockNum(TRun + 1) 'CBE: why add 1 here?
    ...
    Public Sub BackChinArrays()
        ...
        Select Case NumStk 'all cases but >76 are here for backwards compatibility.
            ...
            Case 76
                ...
                TermStockNum(112) = 73
                TermStockNum(113) = 74
            Case Is > 76 ' This has adaptation at the end to accomodate stock splitting.
                ' Note that the mapping BEFORE that is idiosyncratic, and cannot easily be refactored
                ' into a simple loop.
                ...
                TermStockNum(115) = 77
                TermStockNum(116) = 78
                ' The above catches us up to the 78 stocks used through 2023.
                ' The following allows us to extend the stock numbers by splitting some out.
                If NumStk > 78 Then
                    Dim PosValueTracker As Integer = 79 'The first stock beyond those defined above
                    Dim NegValueTracker As Integer = -39 ' the first negative number beyond those defined above.
                    For n As Integer = 117 To (NumStk + NumStk / 2 - 1)
                        If (n Mod 3) = 0 Then
                            TermStockNum(n) = NegValueTracker
                            NegValueTracker = NegValueTracker - 1
                        Else
        ...
        TFish(39, 1) = 5 : TFish(39, 2) = 60 : TFish(39, 3) = 61 : TFish(39, 4) = 62 : TFish(39, 5) = 63 : TFish(39, 6) = 73
